        ...
        */
		...
		function geocodeAll(jsonContent) {
		    return new promise(function (fulfill, reject) {
                ...
                //2000 cities/ a single run (the gonames provider has a 2000 call/hour limit, sadly)
		        var awaitingCities = 2000, index = 0;
		...
		geocodeAll(filterOutEmptyCities(jsonContent)).then(function (data) {
		    ...
		    writeFile("writtenFiles/city.json", json1).then(function (result) { console.log(result); }, function (err) { throw err; });
		    writeFile("writtenFiles/migrations.json", json2).then(function (result) { console.log(result); }, function (err) { throw err; });
		}, function (err) { throw err; });
...
//this function, given a city name and the array of already decoded cities, decides whether the given city was already decoded or not
...
//this function, when given a city name, return's an instance of city constructor with the geodata returned by the gocoder
